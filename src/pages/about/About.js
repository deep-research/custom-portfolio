    ...
    render() {
        return (
            <div>
                ...
                <p class="about-text">I have experience in JavaScript from Northwestern University's Coding Bootcamp. I have also studied Python 3 and MS SQL Server. In addition to my programming skills, I studied religion and music at Lake Forest College. My religious studies also lead me to learning modern astrological interpretation! In fact, the complexity of modern astrology is what inspired me to start coding.</p>
